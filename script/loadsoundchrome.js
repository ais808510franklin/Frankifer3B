...
soundManager.setup({
  ...
  onready: function() {
    ...
    var soundURLs = 'Atk.mp3,Dmg.mp3,R Atk.mp3,Nintendo1Loop.mp3,Pokemon1LoopReal.mp3,menuclick.wav,menuhit.wav,ChampionSelect.mp3,ChampionSelect2.mp3'.split(',');
    for (var i=0; i<soundURLs.length; i++) {
      soundManager.createSound({
        id: 's'+i,
        url: 'audio/'+soundURLs[i]
      });
    }
